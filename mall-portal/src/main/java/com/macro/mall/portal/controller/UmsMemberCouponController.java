...
public class UmsMemberCouponController {
    ...
    @RequestMapping(value = "/list/cart/{adminId}/{type}", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult<List<SmsCouponHistoryDetail>> listCart(@PathVariable Integer type,@PathVariable Long adminId) {
        List<CartPromotionItem> cartPromotionItemList = cartItemService.listPromotion(memberService.getCurrentMember().getId(), null,adminId);
